...
{!! Form::open(array('url' => '/reports/transaction_log', 'id'=>'qwerty', 'class'=>'form-inline')) !!}
            ...
            <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#manageUsers" data-toggle="tab">Transactions Log</a></li>
                </ul>
                ...
                <div class="box-body">
                  <table class="table table-bordered table-striped fullDetailTable2">
                    ...
                    <tbody>                       
                        @foreach($data['playerTransactionLogDataArr'] as $val) 
