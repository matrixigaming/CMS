...
@section('content')
<?php //echo "<pre>"; print_r($cust_data); die;?>
...
{!! Form::open(array('url' => '/player/play')) !!}
                            ...
                            <button type="submit" class="btn btn-sm text" name=""><img src="{{ url('playerapp/play.png')}}" class="img-fluid" style="height: 4vw;width:7vw"></button>
                            {!! Form::close() !!}
<?php else: ?>
