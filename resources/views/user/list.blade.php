          ...
          <div class="row">
          	<div class="col-md-3">                    
          		<!-- <a  href="" class="btn btn-primary btn-block margin-bottom msg-popup-modal" data-toggle="modal" data-controller="user"  data-id="createmsg" data-post="data-php" data-action="create_user">Create User</a>-->
                        <a  href="{{ url('/user/add') }}" class="btn btn-primary btn-block margin-bottom" >Create User</a>
          	</div>
            <div class="col-md-9">
                  ...
                  <table class="table table-bordered table-striped fullDetailTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
<!--<a class="msg-popup-modal" href="" data-toggle="modal"  data-id="{{ $user->id }}" data-post="data-php" data-controller="user" data-action="update_user"><i class="fa fa-pencil"></i></a>-->
<a href="{{ url('/user/edit/'.$user->id) }}"><i class="fa fa-pencil"></i></a></td>
                      </tr>
                      @endforeach 
